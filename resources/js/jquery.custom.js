...
jQuery( document ).ready( function( $ ) {
	...
	(yit_lightbox = function(){
	    ...
	    if( jQuery( 'body' ).hasClass( 'isMobile' ) ) {
	        ...
	        jQuery(".related_lightbox2").colorbox({
    ...
    /* jQuery( '.qweqwe' ).click( function( e ) {

        //

        var lllnk = jQuery(this).attr('attr-lllnk');

        jQuery( '#cboxWrapper' ).append('asdasd = '+ lllnk);
        ...
        alert('ho ' + lllnk);
	        ...
	        jQuery("a.thumb.img, .overlay_img, .section.portfolio .related_proj, a.ch-info-lightbox, a.ch-info-lightbox[rel='lightbox']").colorbox({
	        ...
	        jQuery("a.ch-info-lightboxa[rel='lightboxplan']").colorbox({
	    ...
	    jQuery(".lightbox_related_video").colorbox({
	    ...
	    jQuery(".lightbox_related_video4").colorbox({
	    ...
	    jQuery(".lightbox_related_video2").colorbox({
